...
if ( ! class_exists( 'WC_AM_Client_2_8_1' ) ) {
	class WC_AM_Client_2_8_1 {
		...
		public function __construct( $file, $product_id, $software_version, $plugin_or_theme, $api_url, $software_title = '', $text_domain = '' ) {
			...
			if ( is_admin() ) {
				...
				$this->wc_am_settings_menu_titl         = $this->software_title . esc_html__( ' Activación', $this->text_domain );
    ...
    font-weight: 900;
    background: #ffe6e6;"> La plantilla esta desactivado, adquiera la version extendida <a href="https://plantillasplus.com/item/176/toroflix-movies-and-tvshows-wordpress-theme">Pulsando Aqui</a> o consulte con soporte. (plantillasplus.com)</p>
                </div>
			<?php }
		}
