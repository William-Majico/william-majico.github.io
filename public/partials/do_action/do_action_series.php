		...
		<div class="Info">
            <div class="Vote">
                <div class="post-ratings">
                    <img src="<?php echo TOROFLIX_DIR_URI; ?>public/img/cnt/rating_on.gif" alt="img"><span style="font-size: 12px;"><?php echo $rating; ?></span>
                </div>
            </div>
...
if ( ! function_exists( 'series_info_description' ) ) {
	function series_info_description($data) {
		...
		<div class="Description">
            ...
            <?php if($tags){ ?><p class="Tags"><span><?php _e('Tags', 'toroflix'); ?>:</span> <?php echo $tags; ?></p><?php } ?>
		    ...
		    <main>
				...
				if($seasons){
					foreach ($seasons as $key => $season) { 
						$numberSeason = $loop->number_season_term($season); ?>
				        <section class="SeasonBx AACrdn">
				            <div class="Top AAIco-playlist_play AALink episodes-view episodes-load">
				                <div class="Title"><a href="<?php echo get_term_link( $season ); ?>"><?php _e('Season', 'toroflix'); ?> <span><?php echo $numberSeason; ?></span></a></div>
				            </div>
